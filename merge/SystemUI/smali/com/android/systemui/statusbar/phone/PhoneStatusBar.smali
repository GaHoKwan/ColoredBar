...
.field private SysWhiteKey:Ljava/lang/String;

.field black:Z

.field private mAiromasdnaiudhuiasduiauidauiixzcidasfasd:I

.field private mAiromadsaisdiuadiuauodioajd:I

.field private mIconViewAirom:Ljava/util/ArrayList;
...
.field private mPanYouJie:Z

.field private mStatusBarAirom:I

.field private mTextViewAirom:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.field private mColorAirom:Z

.field private mWhiteAirom:I
...
.method public constructor <init>()V
    ...
    iput-object v1, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->mIconViewAirom:Ljava/util/ArrayList;
    ...
    iput-object v1, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->mTextViewAirom:Ljava/util/ArrayList;

    .line 292
    const/high16 v3, -0x1000000

    iput v3, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->mAiromadsaisdiuadiuauodioajd:I

    .line 293
    const/high16 v1, -0x1000000

    iput v1, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->mAiromasdnaiudhuiasduiauidauiixzcidasfasd:I

    .line 294
    iput v3, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->mWhiteAirom:I

    .line 295
    const/4 v2, 0x1

    iput-boolean v2, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->mPanYouJie:Z

    .line 296
    iput-boolean v2, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->mColorAirom:Z
...
.method static synthetic access$BackAiromColor(Lcom/android/systemui/statusbar/phone/PhoneStatusBar;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/systemui/statusbar/phone/PhoneStatusBar;

    .prologue
    .line 123
    invoke-direct {p0}, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->updateBackground()V
...
.method private checkBarMode(IILcom/android/systemui/statusbar/phone/BarTransitions;)V
    ...
    .line 2207
    :cond_1
    iput-boolean v1, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->mColorAirom:Z
...
.method private getPanyoujie(I)F
    .locals 1
...
.method private getSysColor()I
    .locals 13

    .prologue
    const-wide v11, 0x3ff147ae147ae148L

    const-wide v9, 0x3ff0a3d70a3d70a4L

    const-wide v7, 0x3fefae147ae147aeL
    ...
    .line 3176
    iget-object v4, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->mDisplay:Landroid/view/Display;
    ...
    .line 3179
    const-string v5, "ro.sf.hwrotation"
    ...
    .line 3182
    invoke-direct {p0, v2}, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->getPanyoujie(I)F
    ...
    invoke-static {v3, v0}, Landroid/view/SurfaceControl;->screenshot(II)Landroid/graphics/Bitmap;
    ...
    .line 3195
    :try_start_0
    iget-boolean v6, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->mColorAirom:Z
...
.method private isGray(I)Z
    ...
    .line 3165
    .local v1, "B":I
    const-wide v5, 0x3fd3212d77318fc5L

    int-to-double v7, v3

    mul-double/2addr v5, v7

    const-wide v7, 0x3fe2c8b439581062L
    ...
    const-wide v7, 0x3fbd2f1a9fbe76c9L
...
.method private refresh()V
    ...
    iget v1, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->mAiromadsaisdiuadiuauodioajd:I

    sget-object v2, Landroid/graphics/PorterDuff$Mode;->MULTIPLY:Landroid/graphics/PorterDuff$Mode;

    invoke-direct {p0, v0, v1, v2}, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->setColorForLayout(Landroid/widget/LinearLayout;ILandroid/graphics/PorterDuff$Mode;)V
...
.method private setColorForLayout(Landroid/widget/LinearLayout;ILandroid/graphics/PorterDuff$Mode;)V
    .locals 3
    ...
    .line 3294
    invoke-virtual {v1, p2, p3}, Landroid/widget/ImageView;->setColorFilter(ILandroid/graphics/PorterDuff$Mode;)V
    :try_end_0
...
.method private setStatusBarColor()V
    ...
    .prologue
    .line 3234
    iget-object v3, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->mIconViewAirom:Ljava/util/ArrayList;
    ...
    .line 3236
    iget v3, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->mAiromadsaisdiuadiuauodioajd:I
    ...
    :cond_1
    iget-object v3, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->mTextViewAirom:Ljava/util/ArrayList;
...
.method private updateBackground()V
    ...
    .line 3117
    :cond_1
    invoke-direct {p0}, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->getSysColor()I

    move-result v1

    .line 3118
    .local v1, "mSysColor":I
    iget v2, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->mStatusBarAirom:I

    if-ne v1, v2, :cond_2

    .line 3119
    iget-boolean v2, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->mPanYouJie:Z

    if-nez v2, :cond_3

    .line 3120
    invoke-direct {p0}, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->updateBackgroundAirom()V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .restart local v1    # "mSysColor":I
    :cond_2
    :try_start_1
    iput v1, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->mStatusBarAirom:I

    .line 3126
    :cond_3
    iget-object v2, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->mBattery:Lcom/android/systemui/BatteryMeterView;

    iget v3, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->mStatusBarAirom:I

    .line 3127
    iget-object v2, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->mBattery:Lcom/android/systemui/BatteryMeterView;

    .line 3128
    invoke-direct {p0, v1}, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->isGray(I)Z

    move-result v2

    invoke-virtual {p0, v2}, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->airompanyoujie(Z)V

    .line 3129
    iget-boolean v2, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->mColorAirom:Z
...
.method private updateBackgroundAirom()V
    .locals 4
    ...
    new-instance v1, Lcom/android/systemui/statusbar/phone/PhoneStatusBar$run;

    invoke-direct {v1, p0}, Lcom/android/systemui/statusbar/phone/PhoneStatusBar$run;-><init>(Lcom/android/systemui/statusbar/phone/PhoneStatusBar;)V
...
.method private updateColor()V
    ...
    .line 3142
    iput-boolean v4, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->mPanYouJie:Z

    const/high16 v0, -0x1000000

    iput v0, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->mAiromasdnaiudhuiasduiauidauiixzcidasfasd:I

    const/4 v2, -0x1

    iput v2, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->mWhiteAirom:I
...
# virtual methods
.method public addIcon(Landroid/widget/ImageView;)V
    .locals 2
    ...
    iget-object v0, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->mIconViewAirom:Ljava/util/ArrayList;
    ...
    .line 3265
    iget v0, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->mAiromadsaisdiuadiuauodioajd:I
...
.method public textViewairom(Landroid/widget/TextView;)V
    .locals 1
    ...
    iget-object v0, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->mTextViewAirom:Ljava/util/ArrayList;
...
.method protected makeStatusBarView()Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;
    ...
    invoke-virtual {v0, p0}, Lcom/android/systemui/statusbar/phone/Ticker;->setStatusBar(Lcom/android/systemui/statusbar/phone/PhoneStatusBar;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->textViewairom(Landroid/widget/TextView;)V
    ...
    invoke-virtual {v2, v1}, Lcom/android/systemui/statusbar/SignalClusterView;->findViewById(I)Landroid/view/View;

    move-result-object v3

    check-cast v3, Landroid/widget/ImageView;

    invoke-virtual {p0, v3}, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->addIcon(Landroid/widget/ImageView;)V
...
.method public setColorImageAirom(Landroid/widget/ImageSwitcher;)V
    .locals 4
    .param p1, "switcher"    # Landroid/widget/ImageSwitcher;

    .prologue
    .line 3313
    iget v2, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->mAiromadsaisdiuadiuauodioajd:I
    ...
    .line 3317
    invoke-virtual {p0, v1}, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->addIcon(Landroid/widget/ImageView;)V
...
.method public setAiromColorjj(Landroid/widget/TextSwitcher;)V
    .locals 3
    ...
    .line 3307
    invoke-virtual {p0, v1}, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->textViewairom(Landroid/widget/TextView;)V
...
.method public airompanyoujie(Z)V
    .locals 1
    .param p1, "isBlack"    # Z
    ...
    iget-boolean v0, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->black:Z

    if-nez v0, :cond_2

    .line 3089
    iget v0, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->mAiromasdnaiudhuiasduiauidauiixzcidasfasd:I

    iput v0, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->mAiromadsaisdiuadiuauodioajd:I

    .line 3090
    invoke-direct {p0}, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->refresh()V

    .line 3091
    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->black:Z

    .line 3097
    :cond_0
    :goto_0
    iget-boolean v0, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->mPanYouJie:Z
    ...
    .line 3093
    iget v0, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->mWhiteAirom:I
...
.method protected updateNotificationIcons()V
    ...
    invoke-virtual {v0, v11}, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->addIcon(Landroid/widget/ImageView;)V
